    ...
    <header>
      ...
      <nav>
        ...
        <NavLink to="/apropos" activeclassname="active" exact="">
          <p>A propos</p>
          <i class="fa-solid fa-address-card" aria-label="A propos"></i>
        </NavLink>
        <NavLink to="/formation" activeclassname="active" exact="">
          <p>Formation</p>
          <i class="fa-solid fa-school" aria-label="Formation"></i>
        </NavLink>
        <NavLink to="/projets" activeclassname="active" exact="">
          <p>Projets</p>
          <i class="fa-solid fa-folder" aria-label="Projets"></i>
        </NavLink>
        <NavLink to="/contact" activeclassname="active" exact="">
          <p>Contact</p>
          <i class="fa-solid fa-address-book" aria-label="Contact"></i>
        </NavLink>
      </nav>
